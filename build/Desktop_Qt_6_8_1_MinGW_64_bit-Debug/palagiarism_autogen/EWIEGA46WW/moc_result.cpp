...
static constexpr auto qt_meta_stringdata_ZN6ResultE = QtMocHelpers::stringData(
    "Result",
    "on_back_clicked",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN6ResultE[] = {
...
Q_CONSTINIT const QMetaObject Result::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6ResultE.offsetsAndSizes,
    qt_meta_data_ZN6ResultE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6ResultE_t,
        // Q_OBJECT / Q_GADGET
...
void *Result::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6ResultE.stringdata0))
